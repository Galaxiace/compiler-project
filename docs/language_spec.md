...
| **Составное присваивание** (НОВОЕ) | `+=`             | Сложение с присваиванием | `x += 5`                      |
...
| **Логические** | `&&`             | Логическое И | `a && b`                      |
| | `         \| \|` | Логическое ИЛИ | `a \|             \| b`       |
| | `!`              | Логическое НЕ | `!flag`                       |
| **Побитовые** | `&`              | Побитовое И | `a & b`                       |
| | `\|`             | Побитовое ИЛИ | `a                      \| b` |
| **Стрелка** | `->`             | Возвращаемый тип | `fn add() -> int`             |
...
|-----|----------|--------|----------|
| `int` | Целое число | 32 бита | -2³¹ ... 2³¹-1 |
| `float` | Число с плавающей точкой | 64 бита | ±1.7×10⁻³⁰⁸ ... ±1.7×10³⁰⁸ |
| `bool` | Булево значение | 1 бит | `true` / `false` |
